...
class ProcessingConfig(BaseModel):
    CLIENT_UNIQUE_IDENTIFER: List[str]
    TARGET_VAR: str
    HH_CONT_VARS: List[str]
    HH_ORDINAL_VARS: List[str]
    HH_BOOL_VARS: List[str]
    REDUNDANT_HH_VARS: List[str]
    IND_BOOL_VARS: List[str]
    IND_ORDINAL_VARS: List[str]
    SQUARED_VARS: List[str]
    SELECTED_IND_AGGREGATED_FEATURES: List[str]
...
class ModelConfig(BaseModel):
    ...
    SELECTED_FEATURES_RENAME_MAPPING: Dict[str, str]
    # MODELS_TO_TRY: List[
    #    Literal[
